...
(begin
   ...
   (time " - ff get 10[5]  " (λ () (get ff10 5 False)))
   (time " - vref 1000[500]" (λ () (vec-ref vec1000 500)))
   (time " - fixnum div    " (λ () (/ 2 1)))
   (time " - ff get 100[50]" (λ () (get ff100 50 False)))
   ...
   (time " - mail sink     " (λ () (mail 'sink False)))
   ...
   (time " - interact echo " (λ () (interact 'echo False)))
